# Inventory Optimization Portfolio  
...
### 01_safety_stock_optimization
Statistical analysis of demand and lead-time variability, service level trade-offs, and safety stock parameter setting. Demonstrates how analytical outputs translate into inventory policy decisions.

### 02_lot_size_optimization
Lot sizing and replenishment logic, including EOQ, MOQ constraints, and cost trade-offs. Focuses on balancing inventory efficiency with operational and transportation realities.

### 03_sap_inventory_parameters
Conceptual mapping of inventory optimization decisions to SAP ECC / APO master data and planning parameters. Demonstrates configuration literacy and governance, not just analytical output.

### 04_multi_echelon_inventory
Multi-echelon inventory network thinking, including risk pooling, inventory positioning, and service level propagation across distribution networks.

### 05_inventory_policy_kpis
Inventory governance frameworks, KPI definitions, and performance monitoring standards used to track service, working capital, and inventory health over time.

### 06_executive_presentations
Executive-level presentations that translate analysis into clear decisions, trade-offs, and recommendations suitable for senior leadership.

---

## Tools and Methods Used
- Microsoft Excel for structured inventory modeling and parameter prototyping  
- Python (pandas, numpy, scipy, matplotlib) for scalable statistical analysis and scenario modeling  
- Statistical methods aligned with tools such as Minitab or SPSS  
- SAP ECC / APO conceptual configuration and master data mapping  
- Executive communication via PowerPoint and written policy documentation  

---

## Intended Audience
This portfolio is designed for supply chain leaders, inventory optimization teams, and executives responsible for balancing service performance, working capital, and risk across complex distribution network
